...
local sensordata = { "Temperature_SHT20":format( "%.1f",SHT20_T()), "RHumidity_SHT20": SHT20_RH() , "Illuminace_BH1750" :BH1750() ,"Pressure_BMP180" : format( "%.2f",BMP180.read_pressure_kilopascal()) , "Temperature_BMP180" : BMP180.read_temperature_Celsius(),"Power_supply_voltage" : hardware.voltage()} ;
